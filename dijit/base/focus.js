define([
	...
	"dojo/base/lang", // lang.isArray
	"dojo/topic", // publish
	"dojo/base/window", // win.doc win.doc.selection win.global win.global.getSelection win.withGlobal
	"../focus",
	"../selection",
	...
	var exports = {
		...
		getFocus: function(/*Widget?*/ menu, /*Window?*/ openedForWindow){
			...
			//
			// menu: dijit/WidgetBase|{domNode: DomNode} structure
