define([
	...
	"../a11yclick",
	"./dndContainer"
], function(array, connect, declare, kernel, lang, dom, mouse, on, touch, a11yclick, dndContainer){

	// module:
	//		dijit/tree/dndSelector

	return declare("dijit.tree.dndSelector", dndContainer, {
		// summary:
