define([
	...
	"./dndSelector"
], function(array, connect, declare, domClass, domGeometry, lang, on, touch, topic, DNDManager, dndSelector){
	...
	var dndSource = declare("dijit.tree.dndSource", dndSelector, {
		// summary:
