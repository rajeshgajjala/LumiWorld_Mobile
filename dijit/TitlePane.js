define([
	...
	"./base/manager",    // defaultDuration
	"./a11yclick"	// template uses ondijitclick
], function(array, declare, dom, domAttr, domClass, domGeometry, fxUtils, has, kernel, keys,
			CssStateMixin, TemplatedMixin, ContentPane, template, manager){

	// module:
	//		dijit/TitlePane

	var TitlePane = declare("dijit.TitlePane", [ContentPane, TemplatedMixin, CssStateMixin], {
		// summary:
		...
		postCreate: function(){
			...
			// This should really be controlled from _setToggleableAttr() but CssStateMixin
