define([
	...
	"dojo/NodeList-dom"
], function(array, aspect, declare, lang, parser, query, Widget, TemplatedMixin, WidgetsInTemplateMixin){

	// module:
	//		dijit/Declaration

	return declare("dijit.Declaration", Widget, {
		// summary:
		...
		//		ex: ["dijit.Widget", "dijit.Container"]
		mixins: [],
		...
		buildRendering: function(){
			...
			if(this.mixins.length){
				...
				this.mixins = [ Widget, TemplatedMixin, WidgetsInTemplateMixin ];
			}
