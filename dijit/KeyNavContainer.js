define([
	...
	"./FocusMixin",
	"./KeyNavMixin"
], function(array, declare, domAttr, kernel, keys, lang, registry, Container, FocusMixin, KeyNavMixin){


	// module:
	//		dijit/KeyNavContainer

	return declare("dijit.KeyNavContainer", [FocusMixin, KeyNavMixin, Container], {
		// summary:
		//		A Container with keyboard navigation of its children.
		// description:
		...
		addChild: function(/*dijit/WidgetBase*/ widget, /*int?*/ insertIndex){
			this.inherited(arguments);
			this._startupChild(widget);
		},

		_startupChild: function(/*dijit/WidgetBase*/ widget){
			// summary:
