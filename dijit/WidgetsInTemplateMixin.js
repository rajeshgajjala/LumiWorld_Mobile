define([
	"dojo/base/array", // forEach()
	"dojo/aspect", // after()
	"dojo/base/declare", // declare()
	"dojo/base/lang",	// hitch()
	"dojo/parser" // parse()
	...
	return declare("dijit.WidgetsInTemplateMixin", null, {
		// summary:
		//		Mixin to supplement TemplatedMixin when template contains widgets
		...
		_beforeFillContent: function(){
			if(this.widgetsInTemplate){
				...
				parser.parse(node, {
					...
					// WidgetBase::destroy() will destroy any supporting widgets under this.domNode.
				...
				if(!this._startupWidgets){
					throw new Error(this.declaredClass + ": parser returned unfilled promise (probably waiting for module auto-load), " +
						"unsupported by WidgetsInTemplateMixin.   Must pre-load all supporting widgets before instantiation.");
				}
			}
		},

		_processTemplateNode: function(/*DOMNode|Widget*/ baseNode, getAttrFunc, attachFunc){
			// Override AttachMixin._processNode to skip DOMNodes with data-dojo-type set.   They are handled separately
