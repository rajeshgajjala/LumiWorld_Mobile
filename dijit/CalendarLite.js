define([
...
], function(array, declare, cldrSupplemental, date, locale, stamp, dom, domClass, lang, on, has, string, WidgetBase, TemplatedMixin, template){


	// module:
	//		dijit/CalendarLite

	var CalendarLite = declare("dijit.CalendarLite", [WidgetBase, TemplatedMixin], {
		// summary:
		...
		buildRendering: function(){
			...
			// dateCells and dateLabels arrays filled when Templated parses my template.
			this.dateCells = [];
			this.dateLabels = [];
	...
	CalendarLite._MonthWidget = declare("dijit.CalendarLite._MonthWidget", WidgetBase, {
		// summary:
