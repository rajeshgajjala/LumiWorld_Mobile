define([
	...
	"./focus",
	"./typematic"
], function(declare, domAttr, domClass, domConstruct, keys, lang, on, CssStateMixin, a11yclick, focus, typematic){

	// module:
	//		dijit/PaletteMixin

	var PaletteMixin = declare("dijit.PaletteMixin", CssStateMixin, {
		// summary:
		...
		//		dyeClass should implement the dijit/PaletteMixin.__Dye interface.
		dyeClass: null,
