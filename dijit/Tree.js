define([
	"dojo/base/array", // array.filter array.forEach array.map
	"dojo/aspect",
	"dojo/base/connect", // connect.isCopyKey()
	"dojo/cookie", // cookie
	...
	"dojo/base/lang", // lang.getObject lang.mixin lang.hitch
	...
	"./base/manager", // manager.defaultDuration
	"./Widget",
	"./TemplatedMixin",
	"./Container",
	"./Contained",
	...
	"dojo/query!css2"	// needed when on.selector() used with a string for the selector
			...
			a11yclick, focus, registry, manager, Widget, TemplatedMixin, Container, Contained, CssStateMixin, KeyNavMixin,
			treeNodeTemplate, treeTemplate, TreeStoreModel, ForestStoreModel, dndSelector){
	...
	var TreeNode = declare("dijit._TreeNode", [Widget, TemplatedMixin, Container, Contained, CssStateMixin], {
		// summary:
		...
		// Tooltip is defined in WidgetBase but we need to handle the mapping to DOM here
	...
	var Tree = declare("dijit.Tree", [Widget, KeyNavMixin, TemplatedMixin, CssStateMixin], {
		// summary:
		...
		//		Setting of dijit/tree/dndSelector handles selection only (no actual DnD).
		dndController: dndSelector,
		...
		// Implement KeyNavContainer.childSelector, to identify which nodes are navigable
		...
		_onNodeMouseEnter: function(/*dijit/WidgetBase*/ /*===== node =====*/){
			// summary:
			//		Called when mouse is over a node (onmouseenter event),
			//		this is monitored by the DND code
		},

		_onNodeMouseLeave: function(/*dijit/WidgetBase*/ /*===== node =====*/){
			// summary:
