...
], function(require, declare, domClass, lang, number, Widget, TemplatedMixin, template){

	// module:
	//		dijit/ProgressBar

	return declare("dijit.ProgressBar", [Widget, TemplatedMixin], {
		// summary:
		...
		_setDirAttr: function(val){
			// Normally CssStateMixin takes care of this, but we aren't extending it
