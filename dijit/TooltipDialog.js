define([
...
], function(declare, domClass, has, keys, lang, on, focus, ContentPane, DialogMixin, _FormMixin, TemplatedMixin, template, dijit){
	...
	var TooltipDialog = declare("dijit.TooltipDialog",
		[ContentPane, TemplatedMixin, _FormMixin, DialogMixin], {
			// summary:
