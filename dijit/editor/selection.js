define([
	...
	"dojo/base/window", // win.body win.doc win.doc.createElement win.doc.selection win.doc.selection.createRange win.doc.selection.type.toLowerCase win.global win.global.getSelection
	"../main"		// for exporting symbols to dijit.editor.selection
], function(dom, lang, has, win, dijit){

// module:
//		dijit/editor/selection
...
var selection = {
	...
	getSelectedText: function(){
		...
		if(win.doc.getSelection){
			...
			// IE6-8
			if(dijit.editor.selection.getType() == 'control'){
				return null;
			}
...
lang.setObject("dijit.editor.selection", selection);
