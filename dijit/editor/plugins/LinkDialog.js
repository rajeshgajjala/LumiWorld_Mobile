define([
	...
	"dojo/base/lang", // lang.delegate lang.hitch lang.trim
	"dojo/on",
	"dojo/sniff", // has("ie")
	"dojo/query", // query
	...
	Widget, _Plugin, DropDownButton, rangeapi){

	// module:
	//		dijit/editor/plugins/LinkDialog

	var LinkDialog = declare("dijit.editor.plugins.LinkDialog", _Plugin, {
		// summary:
		...
		_loadDropDown: function(callback){
			...
			require([
				...
				var messages = lang.delegate(i18n.getLocalization("dijit", "common", this.lang),
					i18n.getLocalization("dijit.editor", "LinkDialog", this.lang));
	...
	var ImgLinkDialog = declare("dijit.editor.plugins.ImgLinkDialog", [LinkDialog], {
		// summary:
