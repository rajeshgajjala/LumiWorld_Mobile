define([
	"require",
	"dojo/base/array", // array.indexOf array.map
	"dojo/base/declare", // declare
	"dojo/dom-construct", // domConstruct.place
	"dojo/i18n", // i18n.getLocalization
	"dojo/base/lang", // lang.delegate lang.hitch lang.isString
	...
	registry, Widget, TemplatedMixin, WidgetsInTemplateMixin, FilteringSelect, _Plugin, rangeapi){

	// module:
	//		dijit/editor/plugins/FontChoice

	var _FontDropDown = declare("dijit.editor.plugins._FontDropDown",
		[Widget, TemplatedMixin, WidgetsInTemplateMixin], {
			...
			postMixInProperties: function(){
				...
				this.strings = i18n.getLocalization("dijit.editor", "FontChoice");

				// Set some substitution variables used in the template
				this.label = this.strings[this.command];

				// WidgetBase sets the id after postMixInProperties(), but we need it now.
	...
	var _FontNameDropDown = declare("dijit.editor.plugins._FontNameDropDown", _FontDropDown, {
		// summary:
	...
	var _FontSizeDropDown = declare("dijit.editor.plugins._FontSizeDropDown", _FontDropDown, {
		// summary:
	...
	var _FormatBlockDropDown = declare("dijit.editor.plugins._FormatBlockDropDown", _FontDropDown, {
		// summary:
	...
	var FontChoice = declare("dijit.editor.plugins.FontChoice", _Plugin, {
		// summary:
		...
		//
		//	|	plugins="[{name:'dijit.editor.plugins.FontChoice', command:'fontName', values:['Verdana','Myriad','Garamond']},...]"
		//
