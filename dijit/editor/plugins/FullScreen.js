define([
	...
	// module:
	//		dijit/editor/plugins/FullScreen

	var FullScreen = declare("dijit.editor.plugins.FullScreen", _Plugin, {
		// summary:
		...
		_initButton: function(){
			...
			var strings = i18n.getLocalization("dijit.editor", "commands"),
				editor = this.editor;
		...
		_setFullScreen: function(full){
			...
			if(full){
				...
				this.editorResizeHolder = this.editor.resize;
				ed.resize = function(){
				};
				...
				if(this.editorResizeHolder){
					this.editor.resize = this.editorResizeHolder;
				}
