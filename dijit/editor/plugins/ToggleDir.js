define([
	...
	"dojo/base/kernel", // kernel.experimental
	...
	// module:
	//		dijit/editor/plugins/ToggleDir

	kernel.experimental("dijit.editor.plugins.ToggleDir");

	var ToggleDir = declare("dijit.editor.plugins.ToggleDir", _Plugin, {
		// summary:
