define([
	...
	"dojo/base/lang", // lang.hitch lang.isFunction
	"dojo/on",
	"dojo/touch",
	...
	"./FocusMixin"
			...
			registry, focus, popup, FocusMixin){


	// module:
	//		dijit/HasDropDown

	return declare("dijit.HasDropDown", FocusMixin, {
		// summary:
		...
		_onDropDownMouseDown: function(/*Event*/ e){
			...
			//		2. dropDownButtonActive class applied by CssStateMixin (on button depress)
		...
		_onKey: function(/*Event*/ e){
			...
			if(d && this._opened && e.keyCode == keys.ESCAPE){
				...
				(e.keyCode == keys.DOWN_ARROW ||
					// ignore unmodified SPACE if KeyNavMixin has active searching in progress
		...
		openDropDown: function(){
			...
			var retVal = popup.open({
				...
				onClose: function(){
					...
					self._set("_opened", false);	// use set() because CssStateMixin is watching
				}
			});
			...
			this._set("_opened", true);	// use set() because CssStateMixin is watching
