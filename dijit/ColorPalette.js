define([
	...
	"./Widget", // used also to load dijit/hccss for setting has("highcontrast")
	"./TemplatedMixin",
	"./PaletteMixin",
	"./hccss", // has("highcontrast")
	"dojo/i18n", // i18n.getLocalization
	"dojo/base/Color", // dojo.Color dojo.Color.named
...
], function(require, template, Widget, TemplatedMixin, PaletteMixin, has, i18n, Color,
	declare, domConstruct, string){

	// module:
	//		dijit/ColorPalette

	var ColorPalette = declare("dijit.ColorPalette", [Widget, TemplatedMixin, PaletteMixin], {
		// summary:
		...
		_dyeFactory: function(value, row, col, title){
			// Overrides PaletteMixin._dyeFactory().
