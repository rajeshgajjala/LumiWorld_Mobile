define(["doh/main", "dojo/has"], function(doh, has){
	...
	require(["dijit/Widget"], function(Widget){
		doh.register("dijit.tests.BidiSupport.BidiSupportModule.BidiSupportTest", [
			{
				name:"1. checkContextual(), dir = LTR",

				runTest:function(){
					var bidi = new Widget({textDir:"ltr", dir:"ltr"});
			...
			},
			{
				...
				runTest:function(){
					var bidi = new Widget({textDir:"ltr",dir:"rtl"});
			...
			},
			{
				...
				runTest:function(){
					var bidi = new Widget({textDir:"rtl",dir:"ltr"});
			...
			},
			{
				...
				runTest:function(){
					var bidi = new Widget({textDir:"rtl",dir:"rtl"});
			...
			},
			{
				...
				runTest:function(){
					var bidi = new Widget({textDir:"auto",dir:"ltr"});
			...
			},
			{
				...
				runTest:function(){
					var bidi = new Widget({textDir:"auto",dir:"rtl"});
