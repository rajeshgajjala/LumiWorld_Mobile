...
define([
	"dojo/base/array", "dojo/Deferred", "dojo/promise/all",
	"dojo/dom-attr", "dojo/dom-class", "dojo/dom-geometry", "dojo/dom-style",
	"dojo/base/kernel", "dojo/base/lang", "dojo/on", "dojo/query", "dojo/ready", "dojo/sniff",
...
isVisible: function isVisible(/*dijit/WidgetBase|DomNode*/ node){
	// summary:
...
isHidden: function isHidden(/*dijit/WidgetBase|DomNode*/ node){
	// summary:
