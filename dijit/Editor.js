define([
	...
	"./form/ToggleButton",
	"./editor/_Plugin",
	"./editor/plugins/EnterKeyHandling",
	"./editor/html",
	"./editor/range",
	"./editor/RichText",
	"./main", // dijit._scopeName
	"dojo/i18n!./editor/nls/commands"
], function(require, array, declare, Deferred, i18n, domAttr, domClass, domGeometry, domStyle,
			keys, lang, has, string, topic,
			Container, Toolbar, ToolbarSeparator, _LayoutWidget, ToggleButton,
	...
	var Editor = declare("dijit.Editor", RichText, {
		...
		//		&lt;TEXTAREA&gt; tag -- see dijit/editor/RichText for details.
		...
		//	|	plugins="['bold',{name:'dijit.editor.plugins.FontChoice', command:'fontName', generic:true}]"
		plugins: null,
		...
		postCreate: function(){
			...
			this.commands = i18n.getLocalization("dijit.editor", "commands", this.lang);
