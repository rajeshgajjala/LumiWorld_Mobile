define([
	"require",
	"dojo/base/array", // array.forEach array.indexOf array.map
	"dojo/aspect",
	...
	"dojo/base/fx", // fx.fadeIn fx.fadeOut
	"dojo/i18n", // i18n.getLocalization
	"dojo/keys",
	"dojo/base/lang", // lang.mixin lang.hitch
	"dojo/on",
	"dojo/ready",
	...
	"dojo/i18n!./nls/common"
			...
			Moveable, TimedMoveable, focus, manager, Widget, TemplatedMixin, CssStateMixin, _FormMixin, DialogMixin,
	...
	var _DialogBase = declare("dijit._DialogBase" + (has("dojo-bidi") ? "_NoBidi" : ""), [TemplatedMixin, _FormMixin, DialogMixin, CssStateMixin], {
		...
		//		Set by `dijit/DialogMixin._getFocusItems()`.
		...
		_setDraggableAttr: function(/*Boolean*/ val){
			// Avoid WidgetBase behavior of copying draggable attribute to this.domNode,
	...
	var DialogLevelManager = Dialog._DialogLevelManager = {
		...
		show: function(/*dijit/WidgetBase*/ dialog, /*Object*/ underlayAttrs){
			// summary:
		...
		hide: function(/*dijit/WidgetBase*/ dialog){
			// summary:
		...
		isTop: function(/*dijit/WidgetBase*/ dialog){
			// summary:
