define([
...
], function(require, array, aspect, declare, domAttr, domClass, domConstruct, domStyle, i18n, kernel, keys, lang, on, has, when, a11yclick, fm, Widget, TemplatedMixin, WidgetsInTemplateMixin, Container, Button, _TextBoxMixin, TextBox, template){

	// module:
	//		dijit/InlineEditBox

	var InlineEditor = declare("dijit._InlineEditor", [Widget, TemplatedMixin, WidgetsInTemplateMixin], {
		// summary:
	...
	var InlineEditBox = declare("dijit.InlineEditBox" + (has("dojo-bidi") ? "_NoBidi" : ""), Widget, {
		// summary:
