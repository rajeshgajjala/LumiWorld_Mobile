define([
	...
	"./TemplatedMixin"
			...
			registry, Widget, CssStateMixin, KeyNavContainer, TemplatedMixin){

	// module:
	//		dijit/MenuBase

	return declare("dijit.MenuBase", [Widget, TemplatedMixin, KeyNavContainer, CssStateMixin], {
		// summary:
		...
		onItemClick: function(/*dijit/WidgetBase*/ item, /*Event*/ evt){
			// summary:
