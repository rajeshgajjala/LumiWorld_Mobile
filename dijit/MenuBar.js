...
], function(declare, keys, MenuBase, template){

	// module:
	//		dijit/MenuBar

	return declare("dijit.MenuBar", MenuBase, {
		// summary:
		...
		_moveToPopup: function(/*Event*/ evt){
			...
			//		Unlike MenuBase._moveToPopup(), will never move to the next item in the MenuBar.
			// tags:
			//		private
		...
		_onChildDeselect: function(item){
			// override MenuBase._onChildDeselect() to close submenu immediately
