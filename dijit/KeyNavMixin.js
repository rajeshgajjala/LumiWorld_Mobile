define([
	...
	"dojo/base/lang", // lang.hitch
	"dojo/on",
	"dijit/registry",
	"dijit/FocusMixin"        // to make _onBlur() work
], function(array, declare, domAttr, keys, lang, on, registry, FocusMixin){

	// module:
	//		dijit/KeyNavMixin

	return declare("dijit.KeyNavMixin", FocusMixin, {
		// summary:
		//		A mixin to allow arrow key and letter key navigation of child or descendant widgets.
		//		It can be used by dijit/Container based widgets with a flat list of children,
		...
		_getFirstFocusableChild: function(){
			...
			return this._getNextFocusableChild(null, 1);	// dijit/WidgetBase
		},
		...
		focusChild: function(/*dijit/WidgetBase*/ widget, /*Boolean*/ last){
			// summary:
			...
			if(this.focusedChild && widget !== this.focusedChild){
				this._onChildBlur(this.focusedChild);	// used to be used by MenuBase
			}
		...
		_onChildFocus: function(/*dijit/WidgetBase*/ child){
			// summary:
		...
		onKeyboardSearch: function(/*dijit/WidgetBase*/ item, /*Event*/ evt, /*String*/ searchString, /*Number*/ numMatches){
			// summary:
		...
		_keyboardSearchCompare: function(/*dijit/WidgetBase*/ item, /*String*/ searchString){
			// summary:
		...
		_onContainerKeydown: function(evt){
			...
			if(func){
				...
				evt.stopImmediatePropagation(); // stop a11yclick and HasDropDown from seeing SPACE if we're doing keyboard searching
		...
		_onChildBlur: function(/*dijit/WidgetBase*/ /*===== widget =====*/){
			// summary:
		...
		_getNextFocusableChild: function(child, dir){
			...
			//		Implements and extends KeyNavMixin._getNextFocusableChild() for a Container.
			// child: Widget
			//		The current widget
			// dir: Integer
			//		- 1 = after
			...
			do{
				...
				if(child != null && child != wrappedValue && child.isFocusable()){
					return child;	// dijit/WidgetBase
				}
			}while(child != wrappedValue);
			// no focusable child found
			return null;	// dijit/WidgetBase
		},
