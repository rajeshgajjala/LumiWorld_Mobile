define([
	"dojo/base/array", // array.forEach array.some
	"dojo/aspect",
	...
	var PopupManager = declare(null, {
		...
		open: function(/*__OpenArgs*/ args){
			...
			//		(fired from base/focus.js) to know that focus has moved somewhere else and thus the popup should be closed.
			...
			if(has("config-bgIframe") && !widget.bgIframe){
				// setting widget.bgIframe triggers cleanup in WidgetBase.destroyRendering()
			...
			node.style.visibility = "visible";	// counteract effects from HasDropDown
