define([
	...
	"dojo/i18n!./nls/validate"
			...
			_FormSelectWidget, HasDropDown, DropDownMenu, MenuItem, MenuSeparator, Tooltip, KeyNavMixin, registry, template){
	...
	var Select = declare("dijit.form.Select" + (has("dojo-bidi") ? "_NoBidi" : ""), [_FormSelectWidget, HasDropDown, KeyNavMixin], {
		// summary:
		...
		focus: function(){
			// Override KeyNavMixin::focus(), which calls focusFirstChild().
		...
		focusChild: function(/*dijit/WidgetBase*/ widget){
			// summary:
		...
		childSelector: function(/*DOMNode*/ node){
			// Implement KeyNavMixin.childSelector, to identify focusable child nodes.
