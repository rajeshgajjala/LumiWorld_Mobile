define([
	...
	"dojo/dnd/move",
	"dojo/base/fx", // fx.animateProperty
	...
	"dojo/text!./templates/HorizontalSlider.html"
			...
			manager, focus, typematic, Button, _FormValueWidget, Container, template){
	...
	var HorizontalSlider = declare("dijit.form.HorizontalSlider", [_FormValueWidget, Container], {
		// summary:
