...
], function(declare, domAttr, kernel, has, Widget, TemplatedMixin, _FormMixin, _ContentPaneResizeMixin){

	// module:
	//		dijit/form/Form


	return declare("dijit.form.Form", [Widget, TemplatedMixin, _FormMixin, _ContentPaneResizeMixin], {
		// summary:
