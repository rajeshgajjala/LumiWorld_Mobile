define([
	...
	"./_ListMouseMixin"
			...
			WidgetBase, TemplatedMixin, _ComboBoxMenuMixin, _ListMouseMixin){


	// module:
	//		dijit/form/_ComboBoxMenu

	return declare("dijit.form._ComboBoxMenu",[WidgetBase, TemplatedMixin, _ListMouseMixin, _ComboBoxMenuMixin], {
		// summary:
		...
		// or a different attach point.    See TemplatedMixin::searchContainerNode.
