define([
	...
	"dojo/base/kernel", // deprecated
	"dojo/keys", // keys
	"dojo/base/lang", // lang.mixin
	"dojo/sniff", // has(...)
	"dojo/query", // query
	...
	"./form/_ListMouseMixin"
			...
			WidgetBase, _ListMouseMixin){

	// module:
	//		dijit/TimePicker


	var TimePicker = declare("dijit.TimePicker", [WidgetBase, _ListMouseMixin], {
		// summary:
		...
		//		Must divide dijit/TimePicker.visibleIncrement evenly
		...
		setValue: function(/*Date*/ value){
			...
			// tags:
			//		deprecated
			kernel.deprecated("dijit.TimePicker:setValue() is deprecated.  Use set('value', ...) instead.", "", "2.0");
	...
	/*=====
	 TimePicker.__Constraints = declare(locale.__FormatOptions, {
		 // clickableIncrement: String
		 //		See `dijit/TimePicker.clickableIncrement`
		 clickableIncrement: "T00:15:00"
	 });
	 =====*/
