define([
	...
	"dojo/keys",
	"dojo/base/lang", // getObject() hitch() delegate()
	"dojo/on",
	"dojo/touch",
	"../WidgetBase",
	"../Widget",
	...
	"./utils"        // layoutUtils.layoutChildren
			...
			WidgetBase, Widget, TemplatedMixin, LayoutContainer, layoutUtils){

	// module:
	//		dijit/layout/BorderContainer

	var _Splitter = declare("dijit.layout._Splitter", [Widget, TemplatedMixin ], {
		// summary:
...
//				this.inherited(arguments);
	...
	var _Gutter = declare("dijit.layout._Gutter", [Widget, TemplatedMixin], {
		// summary:
	...
	var BorderContainer = declare("dijit.layout.BorderContainer", LayoutContainer, {
		...
		removeChild: function(/*dijit/WidgetBase*/ child){
	...
	lang.extend(WidgetBase, /*===== {} || =====*/ BorderContainer.ChildWidgetProperties);
