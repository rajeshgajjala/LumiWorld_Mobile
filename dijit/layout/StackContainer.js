define([
...
], function(array, cookie, declare, domClass, domConstruct, has, lang, on, ready, topic, when, registry, WidgetBase, _LayoutWidget){
	...
	var StackContainer = declare("dijit.layout.StackContainer", _LayoutWidget, {
		...
		/*=====
		// selectedChildWidget: [readonly] dijit.Widget
		...
		_setupChild: function(/*dijit/WidgetBase*/ child){
		...
		addChild: function(/*dijit/WidgetBase*/ child, /*Integer?*/ insertIndex){
		...
		removeChild: function(/*dijit/WidgetBase*/ page){
		...
		selectChild: function(/*dijit/WidgetBase|String*/ page, /*Boolean*/ animate){
			// summary:
		...
		_transition: function(newWidget, oldWidget /*===== ,  animate =====*/){
			...
			// newWidget: dijit/WidgetBase
			//		The newly selected widget.
			// oldWidget: dijit/WidgetBase
			...
			if(newWidget.resize){
				if(this.doLayout){
					newWidget.resize(this.ContainerContentBox || this._contentBox);
				}else{
		...
		_adjacent: function(/*Boolean*/ forward){
			...
			return children[ index % children.length ]; // dijit/WidgetBase
		},
		...
		layout: function(){
			...
			if(child && child.resize){
				if(this.doLayout){
					child.resize(this.ContainerContentBox || this._contentBox);
				}else{
					child.resize();
				}
			}
		...
		_showChild: function(/*dijit/WidgetBase*/ page){
			// summary:
		...
		_hideChild: function(/*dijit/WidgetBase*/ page){
			// summary:
		...
		closeChild: function(/*dijit/WidgetBase*/ page){
			// summary:
	...
	lang.extend(WidgetBase, /*===== {} || =====*/ StackContainer.ChildWidgetProperties);
