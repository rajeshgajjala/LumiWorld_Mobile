define([
	...
	"dojo/base/event", // event.stop
	"dojo/base/kernel", // kernel.deprecated
	"dojo/base/lang", // lang.extend lang.hitch
	"dojo/on",
	...
	"./_LayoutWidget"
			...
			event, kernel, lang, on, has, registry, WidgetBase, _LayoutWidget){
...
var SplitContainer = declare("dijit.layout.SplitContainer", _LayoutWidget, {
	...
	addChild: function(/*dijit/WidgetBase*/ child, /*Integer?*/ insertIndex){
		...
		// So, just need to maintain that order so that Container.addChild() puts the widgets where expected.
...
lang.extend(WidgetBase, /*===== {} || =====*/ SplitContainer.ChildWidgetProperties);
