define([
	...
	"dojo/dom-geometry",
	"dojo/keys", // keys
	"dojo/base/lang", // lang.getObject lang.hitch
	...
	"../a11yclick" // AccordionButton template uses ondijitclick; not for keyboard, but for responsive touch.
			...
			focus, manager, ready, Widget, Container, TemplatedMixin, CssStateMixin, StackContainer, ContentPane, template){
	...
	var AccordionButton = declare("dijit.layout._AccordionButton", [Widget, TemplatedMixin, CssStateMixin], {
		// summary:
	...
	var AccordionInnerContainer = declare("dijit.layout._AccordionInnerContainer" + (has("dojo-bidi") ? "_NoBidi" : ""), [Widget, CssStateMixin], {
		// summary:
		...
		/*=====
		 // contentWidget: dijit/WidgetBase
	...
	var AccordionContainer = declare("dijit.layout.AccordionContainer", StackContainer, {
		...
		layout: function(){
			...
			if(openPane){
				openPane.resize(this.ContainerContentBox);
			}
		},
		...
		_transition: function(/*dijit/WidgetBase?*/ newWidget, /*dijit/WidgetBase?*/ oldWidget, /*Boolean*/ animate){
			...
			if(newWidget){
				...
				if(this.doLayout && newWidget.resize){
					newWidget.resize(this.ContainerContentBox);
				}
			}
		...
		_onKeyDown: function(/*Event*/ e, /*dijit/WidgetBase*/ fromTitle){
			// summary:
