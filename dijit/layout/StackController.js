define([
...
], function(array, declare, domClass, domConstruct, keys, lang, on, topic, focus, registry, Widget, TemplatedMixin, Container, ToggleButton){
	...
	var StackController = declare("dijit.layout.StackController", [Widget, TemplatedMixin, Container], {
		// summary:
		...
		onAddChild: function(/*dijit/WidgetBase*/ page, /*Integer?*/ insertIndex){
			// summary:
		...
		onRemoveChild: function(/*dijit/WidgetBase*/ page){
			// summary:
		...
		onSelectChild: function(/*dijit/WidgetBase*/ page){
			// summary:
		...
		onButtonClick: function(/*dijit/WidgetBase*/ page){
			// summary:
		...
		onCloseButtonClick: function(/*dijit/WidgetBase*/ page){
			// summary:
