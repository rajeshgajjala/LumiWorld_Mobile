define([
	...
	"dojo/base/lang", // lang.mixin lang.delegate lang.hitch lang.isFunction lang.isObject
	"../Widget",
	"../Container",
	...
	"dojo/base/xhr", // xhr.get
	"dojo/i18n", // i18n.getLocalization
	"dojo/when"
], function(kernel, lang, Widget, Container, _ContentPaneResizeMixin, string, html, nlsLoading, array, declare,
			Deferred, dom, domAttr, domConstruct, xhr, i18n, when){

	// module:
	//		dijit/layout/ContentPane

	return declare("dijit.layout.ContentPane", [Widget, Container, _ContentPaneResizeMixin], {
		// summary:
		...
		// content: String|DomNode|NodeList|dijit/Widget
		...
		/*======
		 // ioMethod: dojo/base/xhr.get|dojo.base/xhr.post
		...
		// Cancel WidgetBase's _setTitleAttr because we don't want the title attribute (used to specify
		...
		_setContent: function(/*String|DocumentFragment*/ cont, /*Boolean*/ isFakeContent){
			...
			// dojox/layout/html/base::_ContentSetter.set() returns a Promise that indicates when everything is completed.
