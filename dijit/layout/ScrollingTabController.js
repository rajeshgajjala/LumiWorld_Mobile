define([
	...
	registry, tabControllerTemplate, buttonTemplate, TabController, layoutUtils, WidgetsInTemplateMixin,
	Menu, MenuItem, Button, HasDropDown){

	// module:
	//		dijit/layout/ScrollingTabController

	var ScrollingTabController = declare("dijit.layout.ScrollingTabController", [TabController, WidgetsInTemplateMixin], {
		// summary:
		...
		createSmoothScroll: function(x){
			...
			return anim; // dojo/base/fx/Animation
		},
	...
	// Class used in template
	declare("dijit.layout._ScrollingTabControllerMenuButton", [Button, HasDropDown, ScrollingTabControllerButtonMixin], {
