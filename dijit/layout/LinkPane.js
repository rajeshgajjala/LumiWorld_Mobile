...
], function(ContentPane, TemplatedMixin, declare){

	// module:
	//		dijit/layout/LinkPane


	return declare("dijit.layout.LinkPane", [ContentPane, TemplatedMixin], {
		// summary:
		...
		_fillContent: function(){
			// Overrides Templated._fillContent().

			// Templated._fillContent() relocates srcNodeRef innerHTML to templated container node,
