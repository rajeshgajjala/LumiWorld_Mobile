define([
	...
	"./TemplatedMixin",
	"./form/DropDownButton"
], function(array, date, local, declare, domAttr, domClass, kernel, keys, lang, on, has, CalendarLite, Widget, CssStateMixin, TemplatedMixin, DropDownButton){

	// module:
	//		dijit/Calendar

	// Widget for deprecated methods like setAttribute()
	var Calendar = declare("dijit.Calendar", [CalendarLite, Widget, CssStateMixin], {
		// summary:
		...
		// Set node classes for various mouse events, see dijit.CssStateMixin for more details
		cssStateNodes: {
	...
	Calendar._MonthDropDown = declare("dijit.Calendar._MonthDropDown", [Widget, TemplatedMixin], {
		// summary:
