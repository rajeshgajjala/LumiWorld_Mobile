define(["./kernel", "../has", "require", "module", "../json", "./lang", "./array"], function(dojo, has, require, thisModule, json, lang, array) {
	...
	var makeErrorToken = function(id){
		...
		dojoLoadInitPlugin = function(mid, require, loaded){
			...
			//	 });
			//
			//	 define(["dojo", "dojo/loadInit!" + id].concat("dojo/require!dojox/gfx/matric,dojox/gfx/base"), function(dojo){
	...
	// there is exactly one dojoRequirePlugin among possibly-many dojo/base/loader's (owing to mapping)
