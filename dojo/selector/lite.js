define(["../has", "../base/kernel"], function(has, dojo){
"use strict";
...
var liteEngine = function(selector, root){
	...
	// that we don't use dojo/base/window's doc to reduce dependencies, and 
	// fallback to plain document if dojo.doc hasn't been defined (by dojo/base/window).
