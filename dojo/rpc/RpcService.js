define([
	"../base/array", "../base/declare", "../base/Deferred", "../base/kernel","../base/lang",
	"../base/url", "../base/xhr"
...
return declare("dojo.rpc.RpcService", null, {
	...
	errorCallback: function(/* dojo/base/Deferred */ deferredRequestHandler){
		// summary:
	...
	resultCallback: function(/* dojo/base/Deferred */ deferredRequestHandler){
		// summary:
