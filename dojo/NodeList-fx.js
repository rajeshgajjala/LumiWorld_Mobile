define(["./query", "./base/lang", "./aspect", "./base/fx", "./fx"],
...
lang.extend(NodeList, {
	_anim: function(obj, method, args){
		...
		return args.auto ? a.play() && this : a; // dojo/base/fx.Animation|dojo/NodeList
	},
	...
	wipeIn: function(args){
		...
		//
		// args: Object?
		//		Additional dojo/base/fx.Animation arguments to mix into this set with the addition of
		//		an `auto` parameter.
		//
		// returns: dojo/base/fx.Animation|dojo/NodeList
		...
		//		chaining. Otherwise the dojo/base/fx.Animation instance is returned and must be .play()'ed
		//
		// example:
		...
		//
		return this._anim(coreFx, "wipeIn", args); // dojo/base/fx.Animation|dojo/NodeList
	},
	...
	wipeOut: function(args){
		...
		return this._anim(coreFx, "wipeOut", args); // dojo/base/fx.Animation|dojo/NodeList
	},
	...
	slideTo: function(args){
		...
		//		|		top: 50
		//		|	}).play();
		return this._anim(coreFx, "slideTo", args); // dojo/base/fx.Animation|dojo/NodeList
	},
	...
	fadeIn: function(args){
		...
		return this._anim(baseFx, "fadeIn", args); // dojo/base/fx.Animation|dojo/NodeList
	},
	...
	fadeOut: function(args){
		...
		//
		return this._anim(baseFx, "fadeOut", args); // dojo/base/fx.Animation|dojo/NodeList
	},
	...
	animateProperty: function(args){
		...
		//	|		}
		//	|	}).onclick(handler);
		return this._anim(baseFx, "animateProperty", args); // dojo/base/fx.Animation|dojo/NodeList
	},
	...
	anim: function( /*Object*/			properties,
		...
		return canim.play(delay||0); // dojo/base/fx.Animation
	}
});
