...
define([
	"doh/main", "dojo/aspect", "dojo/base/declare", "dojo/base/kernel", "dojo/base/lang"
], function(doh, aspect, declare, kernel, lang){
	doh.register("tests.base.declare", [
		function smokeTest(t){
			declare("tests.base.declare.tmp", null);
			var tmp = new tests.base.declare.tmp();
			declare("testsFoo", null);
			tmp = new testsFoo();
		},
		function smokeTest2(t){
			declare("tests.base.declare.foo", null, {
				foo: "thonk"
			});
			var tmp = new tests.base.declare.foo();
			t.is("thonk", tmp.foo);
		...
		function smokeTestWithCtor(t){
			declare("tests.base.declare.fooBar", null, {
				constructor: function(){
					this.foo = "blah";
				},
				foo: "thonk"
			});
			var tmp = new tests.base.declare.fooBar();
			t.is("blah", tmp.foo);
		},
		function smokeTestCompactArgs(t){
			declare("tests.base.declare.fooBar2", null, {
				foo: "thonk"
			});
			var tmp = new tests.base.declare.fooBar2();
			t.is("thonk", tmp.foo);
		},
		function subclass(t){
			declare("tests.base.declare.tmp3", null, {
				foo: "thonk"
			});
			declare("tests.base.declare.tmp4", tests.base.declare.tmp3);
			var tmp = new tests.base.declare.tmp4();
			t.is("thonk", tmp.foo);
		},
		function subclassWithCtor(t){
			declare("tests.base.declare.tmp5", null, {
				constructor: function(){
					this.foo = "blah";
				},
				foo: "thonk"
			});
			declare("tests.base.declare.tmp6", tests.base.declare.tmp5);
			var tmp = new tests.base.declare.tmp6();
			t.is("blah", tmp.foo);
		},
		function mixinSubclass(t){
			declare("tests.base.declare.tmp7", null, {
				foo: "thonk"
			});
			declare("tests.base.declare.tmp8", null, {
				constructor: function(){
					this.foo = "blah";
				}
			});
			var tmp = new tests.base.declare.tmp8();
			t.is("blah", tmp.foo);
			declare("tests.base.declare.tmp9",
				[
					tests.base.declare.tmp7, // prototypal
					tests.base.declare.tmp8  // mixin
				]);
			var tmp2 = new tests.base.declare.tmp9();
			t.is("blah", tmp2.foo);
		},
		function superclassRef(t){
			declare("tests.base.declare.tmp10", null, {
				foo: "thonk"
			});
			declare("tests.base.declare.tmp11", tests.base.declare.tmp10, {
				constructor: function(){
					this.foo = "blah";
				}
			});
			var tmp = new tests.base.declare.tmp11();
			t.is("blah", tmp.foo);
			t.is("thonk", tests.base.declare.tmp11.superclass.foo);
		},
		function inheritedCall(t){
			var foo = "xyzzy";
			declare("tests.base.declare.tmp12", null, {
				foo: "thonk",
			...
			declare("tests.base.declare.tmp13", tests.base.declare.tmp12, {
				constructor: function(){
					this.foo = "blah";
				}
			});
			var tmp = new tests.base.declare.tmp13();
			t.is("blah", tmp.foo);
			t.is("xyzzy", foo);
			tmp.bar("zot");
			t.is("zot", tmp.foo);
		...
		function inheritedExplicitCall(t){
			var foo = "xyzzy";
			declare("tests.base.declare.tmp14", null, {
				foo: "thonk",
				bar: function(arg1, arg2){
					if(arg1){
						this.foo = arg1;
			...
			declare("tests.base.declare.tmp15", tests.base.declare.tmp14, {
				constructor: function(){
					this.foo = "blah";
				},
				bar: function(arg1, arg2){
				...
				baz: function(arg1, arg2){
					tests.base.declare.tmp15.superclass.bar.apply(this, arguments);
				}
			});
			var tmp = new tests.base.declare.tmp15();
			t.is("blah", tmp.foo);
			t.is("xyzzy", foo);
			tmp.baz("zot");
			t.is("zot", tmp.foo);
		...
		function inheritedMixinCalls(t){
			declare("tests.base.declare.tmp16", null, {
				foo: "",
				bar: function(){
					this.foo += "tmp16";
				}
			});
			declare("tests.base.declare.mixin16", null, {
				bar: function(){
					this.inherited(arguments);
					this.foo += ".mixin16";
				}
			});
			declare("tests.base.declare.mixin17", tests.base.declare.mixin16, {
				bar: function(){
					this.inherited(arguments);
					this.foo += ".mixin17";
				}
			});
			declare("tests.base.declare.tmp17", [tests.base.declare.tmp16, tests.base.declare.mixin17], {
				bar: function(){
					this.inherited(arguments);
					this.foo += ".tmp17";
				}
			});
			var tmp = new tests.base.declare.tmp17();
			tmp.bar();
		...
		function mixinPreamble(t){
			var passed = false;
			declare("tests.base.declare.tmp16", null);
			new tests.base.declare.tmp16({ preamble: function(){ passed = true; } });
			t.t(passed);
		},
		...
		function mutatedMethods(t){
			...
			declare("tests.base.declare.tmp18", null, {
			...
			declare("tests.base.declare.tmp19", tests.base.declare.tmp18, {
			...
			var x = new tests.base.declare.tmp19();
			// smoke tests
			t.is(0, x.flag);
			x.foo();
			t.is(2, x.flag);
			...
			aspect.after(tests.base.declare.tmp19.prototype, "foo", function(){ a = 1; });
			x.foo();
			t.is(2, x.flag);
			t.is(1, a);
			x.clear();
			a = 0;
			// extra chaining
			var old = tests.base.declare.tmp19.prototype.bar;
			tests.base.declare.tmp19.prototype.bar = function(){
				a = 1;
				++this.flag;
				old.call(this);
			};
			...
			a = 0;
			// replacement
			tests.base.declare.tmp19.prototype.baz = function(){
				a = 1;
				++this.flag;
		...
		function modifiedInstance(t){
			var stack;
			declare("tests.base.declare.tmp20", null, {
				foo: function(){ stack.push(20); }
			});
			declare("tests.base.declare.tmp21", null, {
				foo: function(){
					this.inherited(arguments);
					stack.push(21);
				}
			});
			declare("tests.base.declare.tmp22", tests.base.declare.tmp20, {
				foo: function(){
					this.inherited(arguments);
					stack.push(22);
				}
			});
			declare("tests.base.declare.tmp23",
						[tests.base.declare.tmp20, tests.base.declare.tmp21], {
				foo: function(){
					this.inherited(arguments);
					stack.push(22);
				}
			});
			var a = new tests.base.declare.tmp22();
			var b = new tests.base.declare.tmp23();
			var c = {
				foo: function(){
