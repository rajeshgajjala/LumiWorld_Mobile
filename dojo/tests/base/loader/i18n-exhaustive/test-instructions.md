...
The sources required for this test are in dojo/tests/base/loader/i18n-exhaustive. Copy the two directories there to be
...
Finally, the DOH test dojo/tests/base/i18nExhaustive runs all the various combinations.
