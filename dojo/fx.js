define([
	...
	coreFx.chain = function(/*dojo/base/fx.Animation[]*/ animations){
		// summary:
		...
		//	|	]).play();
		//
		return new _chain(animations); // dojo/base/fx.Animation
	};
	...
	coreFx.combine = function(/*dojo/base/fx.Animation[]*/ animations){
		// summary:
		...
		//
		return new _combine(animations); // dojo/base/fx.Animation
	};
