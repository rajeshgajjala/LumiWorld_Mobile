define([ "dojo/base/array",
	...
	return declare("dojox.mobile.LongListMixin", null, {
		...
		// The rest of the methods are overrides of Container and WidgetBase.
		...
		addChild : function(/* dijit._Widget */widget, /* int? */insertIndex){
			// summary: Overrides dijit.Container
			if(this._items){
		...
		getChildren : function(){
			// summary: Overrides dijit.WidgetBase
			if(this._items){
