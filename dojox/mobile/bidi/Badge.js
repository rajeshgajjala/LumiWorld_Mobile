define(["dojo/base/declare", "./common"], function(declare, common){
	...
	return declare(null, {
		...
		// description:
		//		Added textDir attribute, similar to mobile widgets based on dijit.WidgetBase.
		...
		// textDir: String
		//		Mobile widgets, derived from dijit.WidgetBase has this attribute for text direction support (bidi support).
