...
dojo.require("dijit.WidgetBase");
dojo.require("dijit.focus");	// dijit.focus()

dojo.declare("dojox.mobile.app._FormWidget", dijit.WidgetBase, {
	// summary:
	...
	//		You can set them during widget construction or afterwards, via `dijit.WidgetBase.attr`.
	//
	...
	attributeMap: dojo.delegate(dijit.WidgetBase.prototype.attributeMap, {
		value: "focusNode",
		id: "focusNode",
		alt: "focusNode",
		title: "focusNode"
