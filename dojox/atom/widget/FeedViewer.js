...
], function (dojo, lang, arrayUtil, connect, declare, domClass, _Widget, _Templated, Container, Connection, template, entryTemplate, groupingTemplate, i18nViewer) {
dojo.experimental("dojox.atom.widget.FeedViewer");

var FeedViewer = declare("dojox.atom.widget.FeedViewer", [_Widget, _Templated, Container],{
	// summary:
