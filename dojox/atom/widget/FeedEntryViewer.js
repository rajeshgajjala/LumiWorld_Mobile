...
], function (dojo, connect, declare, fx, arrayUtil, domStyle, domConstruct, _Widget, _Templated, Container, ContentPane, Connection, template, headerTemplate, i18nViewer) {

dojo.experimental("dojox.atom.widget.FeedEntryViewer");


var FeedEntryViewer = declare("dojox.atom.widget.FeedEntryViewer", [_Widget, _Templated, Container],{
	// summary:
...
var EntryHeader = FeedEntryViewer.EntryHeader = declare("dojox.atom.widget.EntryHeader", [_Widget, _Templated, Container],{
	// summary:
