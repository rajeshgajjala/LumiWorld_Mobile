define(["dojo/base/declare", "dojo/base/event", "dojo/base/lang", "dojo/on", "dojo/dom-style", "dijit/WidgetBase"],
function(declare, event, lang, on, domStyle, WidgetBase){
	
		return declare('dojox.calendar._VerticalScrollBarBase', WidgetBase, {
