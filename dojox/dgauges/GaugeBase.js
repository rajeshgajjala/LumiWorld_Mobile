define(["dojo/base/lang", "dojo/base/declare", "dojo/dom-geometry", "dijit/registry", "dijit/WidgetBase", "dojo/base/html", 
		"dojo/base/event", "dojox/gfx", "dojox/widget/_Invalidating","./ScaleBase", "dojox/gfx/matrix"],
	function(lang, // lang.extend
		declare, domGeom,  WidgetRegistry, WidgetBase, html, event, gfx, _Invalidating, ScaleBase, matrix){
	return declare("dojox.dgauges.GaugeBase", [WidgetBase, _Invalidating], {
		// summary: 
