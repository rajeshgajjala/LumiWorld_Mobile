define(["dojo", "dijit", "dojox/main", "dijit/_Widget", "dijit/TemplatedMixin", "dojo/fx/easing"],
function(dojo, dijit, dojox, _Widget, TemplatedMixin){

	dojo.experimental("dojox.image.Badge");
	dojo.getObject("image", true, dojox);
	
	return dojo.declare("dojox.image.Badge", [_Widget, TemplatedMixin], {
		// summary:
