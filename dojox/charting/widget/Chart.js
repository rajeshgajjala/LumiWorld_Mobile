define(["dojo/base/kernel", "dojo/base/lang", "dojo/base/array","dojo/dom-attr","dojo/base/declare", "dojo/query",
	"dijit/WidgetBase", "../Chart", "dojo/has", "dojo/has!dojo-bidi?../bidi/widget/Chart", 
	"dojox/lang/utils", "dojox/lang/functional","dojox/lang/functional/lambda"],
	function(kernel, lang, arr, domAttr, declare, query, WidgetBase, ChartBase, has, BidiChart, du, df, dfl){
	...
	var Chart = declare(has("dojo-bidi")? "dojox.charting.widget.NonBidiChart" : "dojox.charting.widget.Chart", WidgetBase, {
		// summary:
