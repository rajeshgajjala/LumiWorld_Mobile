...
dojo.require("dijit.Container");
dojo.require("dojox.wire.ml.util");

dojo.declare("dojox.wire.ml.Data", [dijit._Widget, dijit.Container], {
	// summary:
...
dojo.declare("dojox.wire.ml.DataProperty", [dijit._Widget, dijit.Container], {
	// summary:
