define(["dojo/base/array", "dojo/base/lang", "dojo/base/declare", "dojo/base/event", "dojo/base/Color", "dojo/touch",
		"dojo/when", "dojo/on", "dojo/query", "dojo/dom-construct", "dojo/dom-geometry", "dojo/dom-class", "dojo/dom-style",
		"./_utils", "dijit/WidgetBase", "dojox/widget/_Invalidating", "dojox/widget/Selection",
		"dojo/base/sniff", "dojo/uacss"],
	function(arr, lang, declare, event, Color, touch, when, on, query, domConstruct, domGeom, domClass, domStyle,
		utils, WidgetBase, _Invalidating, Selection, has){

	return declare("dojox.treemap.TreeMap", [WidgetBase, _Invalidating, Selection], {
		// summary:
		//		A treemap widget.
		...
		//		dojo/base/Color constructor. If a value must be returned it must be a Number.
