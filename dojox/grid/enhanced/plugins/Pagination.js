define([
	...
	Button, NumberTextBox, dijitFocus, _Widget, TemplatedMixin, WidgetsInTemplateMixin, metrics, nls){
		
var _GotoPagePane = declare("dojox.grid.enhanced.plugins.pagination._GotoPagePane", [_Widget, TemplatedMixin, WidgetsInTemplateMixin], {
	templateString: "<div>" + 
...
var _Paginator = declare("dojox.grid.enhanced.plugins._Paginator", [_Widget, TemplatedMixin], {
