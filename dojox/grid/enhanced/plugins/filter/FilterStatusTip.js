define([
	...
	TemplatedMixin, WidgetsInTemplateMixin, TooltipDialog, Button, popup, template){
	...
	var FilterStatusPane = declare("dojox.grid.enhanced.plugins.filter.FilterStatusPane", [_Widget, TemplatedMixin], {
