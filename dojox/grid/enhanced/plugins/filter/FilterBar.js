define([
	...
	TemplatedMixin, WidgetsInTemplateMixin, fx, baseFx, string, dijitFocus, template){
...
return declare("dojox.grid.enhanced.plugins.filter.FilterBar", [_Widget, TemplatedMixin, WidgetsInTemplateMixin],{
	// summary:
	//		The filter bar UI.
