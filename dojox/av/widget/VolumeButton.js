define(['dojo', 'dijit', 'dijit/_Widget', 'dijit/TemplatedMixin', 'dijit/form/Button'],	// TODO: why button??
function(dojo, dijit, _Widget, TemplatedMixin, Button){

return dojo.declare("dojox.av.widget.VolumeButton", [_Widget, TemplatedMixin], {
	// summary:
