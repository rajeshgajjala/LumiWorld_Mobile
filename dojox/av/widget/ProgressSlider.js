define(['dojo', 'dijit', 'dijit/_Widget', 'dijit/TemplatedMixin'],function(dojo, dijit, _Widget, TemplatedMixin){

return dojo.declare("dojox.av.widget.ProgressSlider", [_Widget, TemplatedMixin], {
	// summary:
