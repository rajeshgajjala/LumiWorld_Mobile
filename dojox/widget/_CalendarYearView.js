...
], function(declare, _CalendarView, TemplatedMixin, dojoDate, domClass, event, template, _CalendarMonthYearView){
	return declare("dojox.widget._CalendarYearView", [_CalendarView, TemplatedMixin], {
		// summary:
