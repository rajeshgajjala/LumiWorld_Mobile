define([
	...
	"dojo/NodeList-dom"
], function(declare, _CalendarView, TemplatedMixin, query, domClass, event, date, locale, template, supplemental){
	return declare("dojox.widget._CalendarDayView", [_CalendarView, TemplatedMixin], {
		// summary:
