define(["dojo/aspect", "dojo/base/array", "dojo/base/declare", "dojo/dom", "dojo/dom-attr", "dojo/dom-class", "dojo/dom-construct", "dojo/dom-geometry", "dojo/dom-style", "dojo/fx", "dojo/base/kernel", "dojo/keys",
	"dojo/base/lang", "dojo/on", "dijit/WidgetBase", "dijit/TemplatedMixin", "./PagerItem", "dojo/text!./Pager/Pager.html"],
	function(aspect, array, declare, dom, attr, domClass, domConstruct, geometry, style, fx, kernel, keys, lang, on, WidgetBase, TemplatedMixin, PagerItem, template){
