define(["dojo/base/declare", "dojo/base/sniff", "dojo/base/lang", "dojo/aspect", "dojo/dom", "dojo/dom-attr", "dojo/dom-class", "dojo/dom-geometry", "dojo/dom-style", "dojo/dom-construct", "dojo/on", "dojo/base/window", "dojo/mouse", "dijit/WidgetBase", "dijit/TemplatedMixin", "dijit/Container", "./FisheyeListItem"],
	function(declare, has, lang, aspect, dom, attr, domClass, geometry, style, construct, on, winUtil, mouse, WidgetBase, TemplatedMixin, Container, FisheyeListItem){

		return declare("dojox.widget.FisheyeList",
			[WidgetBase, TemplatedMixin, Container], {
				// summary:
