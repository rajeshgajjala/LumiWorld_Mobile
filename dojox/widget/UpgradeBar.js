define([
	"dojo/base/kernel", // dojo.eval
	"dojo/base/array", // array.forEach
	"dojo/base/connect", // connect
	"dojo/base/declare", // declare
	"dojo/base/fx", // baseFx.animateProperty
	"dojo/base/lang", // lang.mixin, lang.hitch
	"dojo/base/sniff", // has("ie")
	"dojo/base/window", // baseWin.body
	...
	"dijit/WidgetBase", // WidgetBase
	"dijit/TemplatedMixin" // TemplatedMixin
], function(dojo, array, connect, declare, baseFx, lang, has, baseWin,
            domAttr, domClass, domConstruct, domGeo, style, cache, cookie,
            domReady, fx, win, WidgetBase, TemplatedMixin){

dojo.experimental("dojox.widget.UpgradeBar");

var UpgradeBar = declare("dojox.widget.UpgradeBar", [WidgetBase, TemplatedMixin], {
	// summary:
