...
], function(WidgetBase, TemplatedMixin, Container, WidgetsInTemplateMixin, dijitTypematic,
		declare, dojoDate, stamp, dojoDateLocale, domStyle, domClass, fx, on, array, lang, template){
	return declare("dojox.widget._CalendarBase", [WidgetBase, TemplatedMixin, Container, WidgetsInTemplateMixin], {
		// summary:
