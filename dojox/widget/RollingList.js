...
dojo.declare("dojox.widget._RollingListPane",
	[dijit.layout.ContentPane, dijit._Templated, dijit.Contained], {
	// summary:
...
dojo.declare("dojox.widget.RollingList",
	[dijit._Widget, dijit._Templated, dijit.Container], {
	// summary:
	...
	_onItemClick: function(/* Event */ evt, /* dijit.Contained */ pane, /* item */ item, /* item[]? */ children){
		// summary:
	...
	_getPaneForItem: function(/* item? */ item, /* dijit.Contained? */ parentPane, /* item[]? */ children){
		// summary:
	...
	_getMenuItemForItem: function(/*item*/ item, /* dijit.Contained */ parentPane){
		// summary:
	...
	getMenuItemForItem: function(/*item*/ item, /* dijit.Contained */ parentPane, /* item[]? */ children){
		// summary:
	...
	getPaneForItem: function(/* item? */ item, /* dijit.Contained? */ parentPane, /* item[]? */ children){
		// summary:
	...
	onItemClick: function(/* item */ item, /* dijit.Contained */ pane, /* item[]? */ children){
		// summary:
