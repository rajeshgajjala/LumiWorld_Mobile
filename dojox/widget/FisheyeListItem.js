define(["dojo/base/declare", "dojo/base/sniff", "dojo/dom", "dojo/dom-attr", "dojo/dom-class", "dojo/dom-style", "dojo/dom-construct", "dojo/base/window", "dijit/WidgetBase", "dijit/TemplatedMixin", "dijit/Contained"],
	function(declare, has, dom, attr, domClass, style, construct, winUtil, WidgetBase, TemplatedMixin, Contained){

	return declare("dojox.widget.FisheyeListItem",
		[WidgetBase, TemplatedMixin, Contained], {
		// summary:
