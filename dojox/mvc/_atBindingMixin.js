define([
	...
	function getParent(/*dijit/WidgetBase*/ w){
		// summary:
	...
	function bind(/*dojo/Stateful|String*/ source, /*String*/ sourceProp, /*dijit/WidgetBase*/ target, /*String*/ targetProp, /*dojox/mvc/sync.options*/ options){
		// summary:
	...
	var mixin = {
		// summary:
		//		The mixin for dijit/WidgetBase to support data binding.
