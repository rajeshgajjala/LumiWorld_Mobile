define([
	...
	"dijit/WidgetBase",
	"./Templated"
], function(require, array, lang, declare, Container, WidgetBase, Templated){
	...
	var WidgetList = declare("dojox.mvc.WidgetList", [WidgetBase, Container], {
		// summary:
		...
		// |				<div>
		// |					<span data-dojo-type="dijit/WidgetBase"
