...
], function(dojo, dijit, dojox, popup, _Widget, TemplatedMixin, WidgetsInTemplateMixin, _Plugin) {

dojo.experimental("dojox.editor.plugins.TextColor");

var TextColorDropDown = dojo.declare("dojox.editor.plugins._TextColorDropDown", [_Widget, TemplatedMixin, WidgetsInTemplateMixin], {
	// summary:
