...
], function(dojo, dijit, dojox, _Widget, TemplatedMixin, _Plugin) {

var CollapsibleToolbarButton = dojo.declare("dojox.editor.plugins._CollapsibleToolbarButton", [_Widget, TemplatedMixin], {
	// summary:
