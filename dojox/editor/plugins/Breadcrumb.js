...
], function(dojo, dijit, dojox, _Widget, TemplatedMixin, Contained, Toolbar, Menu, MenuItem,
	MenuSeparator, _Plugin) {

dojo.experimental("dojox.editor.plugins.Breadcrumb");

var BreadcrumbMenuTitle = dojo.declare("dojox.editor.plugins._BreadcrumbMenuTitle",[_Widget, TemplatedMixin, Contained],{
	// summary:
