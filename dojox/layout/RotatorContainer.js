define(["dojo/base/declare","dojo/base/html","dojo/base/connect","dojo/base/lang","dojo/base/array",
	"dojo/base/fx","dojo/fx","dijit/_base/manager","dijit/layout/StackContainer","dijit/layout/StackController","dijit/_Widget",
	"dijit/_Templated","dijit/Contained"
...
var RotatorContainer = declare("dojox.layout.RotatorContainer",[StackContainer, Templated], {
	...
	_fade: function(/*dijit._Widget*/ next, /*dijit._Widget*/ prev){
		...
		if(this.doLayout && next.resize){
			next.resize(this.ContainerContentBox || this._contentBox);
		}
