define([
...
],function(dojo, template, declare, query, has, domClass, domStyle, geom, domConstruct, domAttr, array, lang, events, keys, topic, registry, focus, baseFocus, WidgetBase, TemplatedMixin, _LayoutWidget, NodeList){

	var gcl = declare(
		"dojox.layout.GridContainerLite",
		[_LayoutWidget, TemplatedMixin],
	{
		// summary:
	...
	lang.extend(WidgetBase, /*===== {} || =====*/ gcl.ChildWidgetProperties);
