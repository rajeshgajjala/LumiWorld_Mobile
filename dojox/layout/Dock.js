define(["dojo/base/lang", "dojo/base/window", "dojo/base/declare",
		"dojo/base/fx", "dojo/on", "dojo/base/array", "dojo/base/sniff",
		"dojo/window", "dojo/dom", "dojo/dom-class", "dojo/dom-geometry", "dojo/dom-construct",
		"dijit/TemplatedMixin", "dijit/WidgetBase", "dijit/BackgroundIframe", "dojo/dnd/Moveable",
	...
	has, windowLib, dom, domClass, domGeom, domConstruct, TemplatedMixin, WidgetBase, BackgroundIframe, 
...
var Dock = declare("dojox.layout.Dock",[WidgetBase, TemplatedMixin],{
	// summary:
...
var DockNode = declare("dojox.layout._DockNode",[WidgetBase, TemplatedMixin],{
	// summary:
