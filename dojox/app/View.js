define(["require", "dojo/when", "dojo/on", "dojo/base/declare", "dojo/base/lang", "dojo/Deferred",
		"dijit/Destroyable", "dijit/TemplatedMixin", "dijit/WidgetsInTemplateMixin", "./ViewBase", "./utils/nls"],
	function(require, when, on, declare, lang, Deferred, Destroyable, TemplatedMixin, WidgetsInTemplateMixin, ViewBase, nls){

	return declare("dojox.app.View", [TemplatedMixin, WidgetsInTemplateMixin, Destroyable, ViewBase], {
		// summary:
		...
		// TemplatedMixin requires a connect method if data-dojo-attach-* are used
